      ...
      <div className="flex flex-col min-h-full pt-16 pb-12 bg-white">
        <main className="flex flex-col justify-center flex-grow w-full px-6 mx-auto max-w-7xl lg:px-8">
          <div className="flex justify-center flex-shrink-0">
            <Link href="/-123.361940,48.408510" className="inline-flex">
          ...
          <div className="py-16">
            <div className="text-center">
              ...
              <div className="mt-6">
                <Link href="/-123.361940,48.408510,12" className="text-base font-medium text-yellow-700 hover:text-yellow-900">
                  Return to home
